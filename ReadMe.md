...
- [Submit an issue](https://github.com/CedX/FreeMobile.net/issues)

## License
[Free Mobile for .NET](https://github.com/CedX/FreeMobile.net) is distributed under the MIT License.
